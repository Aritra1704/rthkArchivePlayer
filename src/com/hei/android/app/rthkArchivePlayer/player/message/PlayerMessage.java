...
public class PlayerMessage {
	...
	public static Message createBufferUpdateMessage(boolean isPlaying, int audioBufferSizeMs, int audioBufferCapacityMs) {
		final Message msg =  new Message();
	...
	public static Message createExceptionMessage(Throwable t) {
		final Message msg =  new Message();
		msg.what = EXCEPTION;
	...
	public static boolean getIsPlaying(Message msg) {
	...
	public static int getAudioBufferSize(Message msg) {
		if (msg.what == BUFFER_UPDATE) {
			final Bundle data = msg.getData();
	...
	public static int getAudioBufferCapacity(Message msg) {
		if (msg.what == BUFFER_UPDATE) {
			final Bundle data = msg.getData();
	...
	public static Throwable getException(Message msg) {
