...
public class ActionBarHelperBase extends ActionBarHelper {
	...
	public void onPostCreate(Bundle savedInstanceState) {
		...
		ActionBarMenu menu = new ActionBarMenu(mActivity);
	...
	private View addActionItemCompatFromMenuItem(final MenuItem item) {
		...
		if (itemId == R.id.menu_refresh) {
			...
			actionButton.setId(R.id.actionbar_compat_item_search);
		}
		...
		if(itemId == R.id.menu_search) {
			final EditText editText = new EditText(mActivity, null, R.attr.actionbarCompatSearchEditTextStyle);
			final LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(
					0, ViewGroup.LayoutParams.FILL_PARENT, 1);
			editText.setLayoutParams(layoutParams);
			editText.setId(R.id.actionbar_compat_item_search_edit_text);
			...
			actionBar.addView(editText);

			actionButton.setOnClickListener(new View.OnClickListener() {
				public void onClick(View view) {
					final View title = mActivity.findViewById(R.id.actionbar_compat_title);
					final EditText editText = (EditText) mActivity.findViewById(R.id.actionbar_compat_item_search_edit_text);
					final View search = mActivity.findViewById(R.id.actionbar_compat_item_search);
					final View searchCancel = mActivity.findViewById(R.id.actionbar_compat_item_search_cancel);
		...
		if (itemId == R.id.menu_refresh) {
			...
			final ImageButton searchCancel = new ImageButton(mActivity, null, R.attr.actionbarCompatItemStyle);
			searchCancel.setLayoutParams(new ViewGroup.LayoutParams(
					(int) mActivity.getResources().getDimension(R.dimen.actionbar_compat_button_width),
					ViewGroup.LayoutParams.FILL_PARENT));
			searchCancel.setImageResource(R.drawable.menu_search_cancel);
			searchCancel.setId(R.id.actionbar_compat_item_search_cancel);
			searchCancel.setVisibility(View.GONE);
			searchCancel.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					final View title = mActivity.findViewById(R.id.actionbar_compat_title);
					final View editText = mActivity.findViewById(R.id.actionbar_compat_item_search_edit_text);
					final View search = mActivity.findViewById(R.id.actionbar_compat_item_search);
					final View searchCancel = mActivity.findViewById(R.id.actionbar_compat_item_search_cancel);
			...
			actionBar.addView(searchCancel);
		}
